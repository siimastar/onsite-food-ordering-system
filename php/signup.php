...
$query="INSERT INTO users(name,username,password,con_pass,email,phone) VALUES('{$name}','{$username}','{$password}','{$confirmpassword}','{$email}','{$phone}')";
...
<div id="wrap">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?> ">
            ...
            <input type='text' name='phone' placeholder="08169895827" ><br/>
